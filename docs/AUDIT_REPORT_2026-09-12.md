...
5. ~~Registration number~~: the Jordanian national establishment number **200201310** is now in `src/content/site/company.ts` as `nationalNumber`; the site footer, the registration block and every document footer print it under both labels.
